#include "options.h"
void choix_options(SDL_Surface *ecran,int *stage_dispo,int *difficulter ){
int continuer=1,i_video=1,i_audio=1,i_menu=1,i_langage=1,i_difficulty=1,verif_video=2,verif_audio=3,verif_langage=1,verif_difficulty=1;
SDL_Event event;
...
fclose(fichier);
Nettoyer_choix_stage(choix_options);
menu_principale(ecran,stage_dispo,difficulter);break;
...
void Nettoyer_choix_stage(SDL_Surface *choix_options){
SDL_FreeSurface(choix_options);
}
