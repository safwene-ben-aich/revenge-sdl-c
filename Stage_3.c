...
void main_stage_3(SDL_Surface *ecran, int stage)
{


    SDL_Rect position_personnage,position_police,position_police_2,position_police_3,position_police_4,position_elevator_1,position_exit,position_efface_1,position_efface_2;
    ...
    SDL_Event event;
    int continuer=1,nombre_sprite=0,nombre_frame=1,verif_direction=3,nombre_sprite_police=0,nombre_frame_police=1,direction_police=6,direction_police_2=6,direction_police_3=6,direction_police_4=6;
    ...
    int compteur_saut=0,mouvement_haut=0,verif_gravite=0,mouvement_escalier=0,compteur_escalier=0,num_elevator=1,verif_changement_elevator=0,verif_direction_2;

    SDL_Surface *fond_base=NULL,*sprite=NULL,*sprite_test=NULL,*map_test=NULL,*you_win=NULL,*you_lose=NULL;
...
{
if ((position_personnage.x<1200 && position_personnage.x>1150) || (position_personnage.x<950 && position_personnage.x>900))
{
...
{
if (position_exit.x-position_police.x<70 && *(etat_bouton_1)==1 && position_exit.y>550 && *(mouvment_exit)==1)
{
*(verif_kill)=1;
}
}
